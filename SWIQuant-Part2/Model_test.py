...
class ModelEvalu(object):
    ...
    def test_all(self, path):
        ...
        for metrics, value in zip(['Sens', 'Prec', 'Fp', 'Err', 'DErr', 'T'], [Sens, Prec, Fp_min, Err, DErr, T]):
...
if __name__ == "__main__":
    ...
    for input_size, epoch in zip(input_sizes, epochs):
        model_eval = ModelEvalu(layers_num=4, input_size=input_size, epoch=epoch, model_root='modelnew', mode='U-net')
